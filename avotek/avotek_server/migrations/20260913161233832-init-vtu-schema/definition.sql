...
--
-- Class ServiceCatalog as table service_catalog
--
...
--
-- Class WebhookLog as table webhooks_log
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('avotek', '20260913161233832-init-vtu-schema', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260913161233832-init-vtu-schema', "timestamp" = now();
