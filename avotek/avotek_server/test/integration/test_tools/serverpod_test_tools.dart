...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:avotek_server/src/generated/order.dart' as _i5;
import 'package:avotek_server/src/generated/transaction.dart' as _i6;
import 'package:avotek_server/src/generated/user.dart' as _i7;
import 'package:avotek_server/src/generated/audit_log.dart' as _i8;
import 'package:avotek_server/src/generated/auth_response.dart' as _i9;
import 'package:avotek_server/src/generated/service_catalog.dart' as _i10;
import 'package:avotek_server/src/generated/beneficiary.dart' as _i11;
import 'package:avotek_server/src/generated/order_result.dart' as _i12;
import 'package:avotek_server/src/generated/verification_response.dart' as _i13;
import 'package:avotek_server/src/generated/wallet_summary.dart' as _i14;
import 'package:avotek_server/src/generated/greetings/greeting.dart' as _i15;
import 'package:avotek_server/src/generated/protocol.dart';
import 'package:avotek_server/src/generated/endpoints.dart';
...
class _AdminEndpoint {
  ...
  _i3.Future<bool> manualRefundOrder(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'admin',
            method: 'manualRefundOrder',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'admin',
          methodName: 'manualRefundOrder',
          parameters: _i1.testObjectToJson({
            'orderId': orderId,
            'adminId': adminId,
            'reason': reason,
  ...
  _i3.Future<List<_i8.AuditLog>> getAuditLogs(
    _i1.TestSessionBuilder sessionBuilder, {
    required int limit,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i10.ServiceCatalog>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i11.Beneficiary>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i11.Beneficiary>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i12.OrderResult>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i13.VerificationResponse>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i13.VerificationResponse> verifySmartcard(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'order',
            method: 'verifySmartcard',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'order',
          methodName: 'verifySmartcard',
          parameters: _i1.testObjectToJson({
            'provider': provider,
            'smartcardNumber': smartcardNumber,
          }),
...
class _WalletEndpoint {
  ...
  _i3.Future<_i14.WalletSummary> getWallet(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i14.WalletSummary>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i6.Transaction> fundWalletSimulate(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'wallet',
            method: 'fundWalletSimulate',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'wallet',
          methodName: 'fundWalletSimulate',
          parameters: _i1.testObjectToJson({
            'userId': userId,
            'amount': amount,
            'reference': reference,
...
class _WebhookEndpoint {
  ...
  _i3.Future<bool> handleWhatsAppWebhook(
    _i1.TestSessionBuilder sessionBuilder,
    String payload,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
